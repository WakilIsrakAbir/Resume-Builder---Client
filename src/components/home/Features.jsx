    ...
    return (
      ...
      >
        ...
        <Title
          ...
          discription="Our streamlined process helps you create a profetional resume in minutes with intelligent AI-powered tools and feature."
        ></Title>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-600 max-w-xs">
                    Let smart AI write, edit, and optimize your resume content
                    with industry-specific suggestions to help you land your
                    dream job faster.
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
              <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-600 max-w-xs">
                    Customize layouts and update your professional details
                    instantly with an intuitive, easy-to-use live editor.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
              <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-600 max-w-xs">
                    Download your completed, ATS-friendly resume instantly in
                    high-quality formats, ready for immediate application
                    submission.
                  </p>
                </div>
              </div>
